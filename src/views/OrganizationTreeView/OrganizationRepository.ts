...
export class OrganizationRepository extends Repository {
  ...
  public importAppUser = (
    ...
    return this.http
      .post<void>(kebabCase(nameof(this.importAppUser)), formData, {
        headers: {
  ...
  public exportTemplateAppUser = (
    organizationFilter?: OrganizationFilter,
  ): Promise<AxiosResponse<any>> => {
    return this.http.post('export-template-app-user', organizationFilter, {
      responseType: 'arraybuffer',
    });
  };
}
