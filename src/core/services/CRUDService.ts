...
import React, { Dispatch, SetStateAction, RefObject, useCallback, useMemo, useContext, useEffect, useState } from 'react';
...
export class CRUDService {
  ...
  public useImport<TFilter extends ModelFilter>(
    ...
    return [handleChange, handleClick, ref, errVisible, setErrVisible, errorModel];
  }
  ...
  public useAction(module: string, baseAction: string, baseSite: string) {
    ...
    useEffect(() => {
      ...
      const regex = new RegExp(`^(rpc/${baseSite}/${module})/`, 'i');
    ...
    const buildAction = useCallback((action: string) => {
